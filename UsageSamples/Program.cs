	...
	class Program
	{
		static void Main(string[] args)
		{
			string persianSampleDateString1 = "1393/08/01 21:53:26";
			  persianSampleDateString1 = "1393/08/01";
			...
			Debug.WriteLine(datetime1.ToFa("f"));//1393/08/01 21:53
			...
			Debug.WriteLine(datetime1.ToFaWithTime());//جمعه اول آبان 1393
			Debug.WriteLine("1393/08/01 21:00".ToEn().ToFa("YYYY/MM/dd hh:mm"));// "1393/08/01 21:00"
													  /////////part 2
