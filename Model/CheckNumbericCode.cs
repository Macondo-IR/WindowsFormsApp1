...
namespace Model
{
    ...
    {
        public static Boolean IsValidNationalCode(this String nationalCode, ref string error)
        {
            //در صورتی که کد ملی وارد شده تهی باشد

            if (String.IsNullOrEmpty(nationalCode))
            { 
            error = "لطفا کد ملی را صحیح وارد نمایید";
            ...
            {
                error = "طول کد ملی باید ده کاراکتر باشد";
            ...
            {
                error = "کد ملی تشکیل شده از ده رقم عددی می‌باشد؛ لطفا کد ملی را صحیح وارد نمایید";
            ...
            {
                error = "رقم‌های کد ملی وارد شده یکسان باشد";
                //throw new Exception("رقم‌های کد ملی وارد شده یکسان باشد");
                return  false;
            }
